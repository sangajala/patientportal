Feature: Registration
  ...
  Scenario Outline: Validations
    ...
    Examples:
      ...
      |                    | b0dc8       | Bananaapps123$ | myn        |           | 23  |       |      |                       |          |                     | Date of birth isn't set.     |
      |                    | b0dc8       | Bananaapps123$ | myn        | myn       |     | Jun   |      |                       |          |                     | Date of birth isn't set.     |
      |                    | b0dc8       | Bananaapps123$ | myn        |           |     |       | 1986 |                       |          |                     | Email address isn't set.     |
      |                    | b0dc8       | Bananaapps123$ | myn        |           | 23  | Jun   | 1986 | keerthi.allagmail.com |          |                     | Post code isn't set.         |
      |                    | b0dc8       | Bananaapps123$ | myn        |           |     |       |      | keerthi.allagmail.com | 1        |                     | Phone number isn't set.      |
